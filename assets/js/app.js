jQuery(document).ready(function() {
    ...
    jQuery(".chosen-select,.chosen-select-two,.chosen-select-three,.chosen-select-four,.chosen-select-five,.chosen-select-six").chosen();
   ...
   $('.nstSlider').nstSlider({
    ...
    $(".clients-slider").owlCarousel({
     ...
     PAGE LOADER
    ----------------------------------------------------------- */
    $('.spinner-wrapper').delay(900).fadeOut('fast'); 
});