            ...
            <div class="container">
                <div class="breadcrumb-area">
                    ...
                    <ul class="breadcrumbs">
                        <li>Home</li>
                        <li class="active">Complete Project</li>
                    </ul>
                </div>
            </div>
        </div>
...
<br>
 ...
 <?php 
                $groupo_sec_1 = cs_get_option('group_60');
...
<div class="property-listing-list wow fadeInDown delay-07s" style="visibility: visible; animation-name: fadeInDown;">
    <a>
        <div class="col-xs-12 col-sm-12 col-md-6 nopadd">
            ...
            <img class="img-responsive " src="<?php  echo wp_get_attachment_image_src($group_value_1['text_70'],'full')[0]; ?>">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 nopadd">
            <div class="content-block">
                ...
                <h4>
                    <?php echo $group_value_1['text_71']; ?>
                </h4>
            </div>
